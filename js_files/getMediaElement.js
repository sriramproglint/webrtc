...
// __________________
// getMediaElement.js
var getMediaElementEntry = 0;
var getMediaBoxEntry = 0;
...
function getMediaElement(mediaElement, config) {
    ...
    // if(getMediaElementEntry == 0){
    //     mediaElementContainer.className = 'media-container';
    //     mediaControls.className = 'media-controls';
    //     getMediaElementEntry ++;
    // }else{
    //     mediaElementContainer.className = 'media-container1';
    //     mediaControls.className = 'media-controls1';
    // }
    mediaElementContainer.className = 'video-height-panel';
    ...
    if (buttons.has('mute-audio')) {
        ...
        // muteAudio.className = '' + (config.toggle.has('mute-audio') ? 'unmute-audio selected' : 'mute-audio');
    ...
    // console.log("alert(getMediaBoxEntry)"+getMediaBoxEntry);
    // if(getMediaBoxEntry == 0){
    //     mediaBox.className = 'friend-face';
    //     getMediaBoxEntry ++;
    // }else{
    //     mediaBox.className = 'friend-face';
    // }
    ...
    // mediaElementContainer.querySelector('video').style.maxHeight = innerHeight + 'px';

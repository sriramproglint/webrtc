(function(connection) {
    ...
    mPeer.onGettingRemoteMedia = function(stream, remoteUserId) {
        console.log("onGettingRemoteMedia" + stream, remoteUserId);
        try {
            stream.type = 'remote';
        } catch (e) {}
    ...
    connection.open = function(localUserid, isPublicModerator) {
        console.log("connnection opening with userId");
        console.log("localUserid " + localUserid + " " + connection.userid + " " + connection.sessionid);
        var oldUserId = connection.userid;
        connection.userid = connection.sessionid = localUserid || connection.sessionid;
        connection.userid += '';

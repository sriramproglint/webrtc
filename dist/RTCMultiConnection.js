        ...
        function handle(connection) {
            ...
            connection.onFileStart = function(file) {
                ...
                if(connection.userid === file.userid){
                    file.username = connection.name;
                    div.className = "second-chat";
                    div.innerHTML = `
                    <div class="media">
                        <div class="media-body with-caption-right">
                            <div class="message">
                                <div class="chatFileView"></div>
                                <div class='chatFileIndicator chatFileIndicator_${file.uuid}'></div>
                                <p>
                    ...
                    <div class="media">
                        <div class="media-body with-caption-left">
                            <div class="message">
                                <h6 class="capitalize">${file.username}</h6>
                                <div class="chatFileView"></div>
                                <div class='chatFileIndicator chatFileIndicator_${file.uuid}'></div>
                                <p>
                                    <span class="chat_message_time pull-right">${formatAMPM(new Date())}</span>
                ...
                connection.filesContainer.insertBefore(div, connection.filesContainer.lastChild);

                $('.chatFileIndicator_'+file.uuid).radialIndicator({
                    barColor: '#87CEEB',
                    barWidth: 5,
                    initValue: 0,
                    roundCorner : true,
            ...
            connection.onFileProgress = function(chunk) {
                ...
                $('.chatFileIndicator_'+chunk.uuid).html('');
                $('.chatFileIndicator_'+chunk.uuid).radialIndicator({
                    barColor: '#87CEEB',
                    barWidth: 5,
                    initValue: chunk.currentPosition || chunk.maxChunks || helper.progress.max,
                    roundCorner : true,
                    percentage: true
                });
            ...
            connection.onFileEnd = function(file) {
                ...
                $('.chatFileIndicator_'+file.uuid).css('display', 'none');
                // var div = helper.div;
                var div = helper.div.querySelector('.chatFileView');
                if (file.type.indexOf('image') != -1) {
                    div.innerHTML = 
                        `
                            <div class="chatFile">
                                <img class="image" src="${file.url}" title="${file.name}" style="max-width: 80%;" />
                                <div class="chatFileOption">
                                    <a class="download-icon btn btn-primary" title="Download" href="${file.url}" download="${file.name}">
                                        <i class="fa fa-arrow-circle-down" aria-hidden="true"></i> 
                                    </a>
                                    <button class="view-icon btn btn-primary" title="View" onclick="viewImageModal('${file.url}', '${file.name}')">
                                        <i class="fa fa-eye" aria-hidden="true"></i> 
                                    </button>
                                </div>
                            </div>
                        `
                        // '<a href="' + file.url + '" download="' + file.name + '">Download <strong style="color:red;">' + file.name + '</strong> </a><br />';
                } else if(file.type.indexOf('video') != -1){
                    div.innerHTML = 
                        `
                            <div class="chatFile">
                                <video class="image" src="${file.url}" title="${file.name}" style="max-width: 80%;">
                                ...
                                <div class="chatFileOption">
                                    ...
                                    <button class="view-icon btn btn-primary" title="View" data-target="" onclick="viewVideoModal('${file.url}', '${file.name}')">
                                        <i class="fa fa-eye" aria-hidden="true"></i> 
                                    </button>
                                </div>
                            </div>
                    ...
                    div.innerHTML = 
                        `
                            <div class="chatFile chatFileDownloadable">
                                <div class="image" title="${file.name}" style="max-width: 80%;">
                ...
                setTimeout(function(){
                    $('.chatFileIndicator_'+file.uuid).html('');
                }, 2000);
            };
    ...
    (function(connection) {
        ...
        mPeer.onGettingLocalMedia = function(stream) {
            ...
            getRMCMediaElement(stream, function(mediaElement) {
                ...
                connection.onstream(connection.streamEvents[stream.streamid], true);
            }, connection);
        };
        ...
        mPeer.onGettingRemoteMedia = function(stream, remoteUserId) {
            ...
            getRMCMediaElement(stream, function(mediaElement) {
                ...
                setMuteHandlers(connection, connection.streamEvents[stream.streamid]);
                connection.onstream(connection.streamEvents[stream.streamid], false);
            }, connection);
        };
            ...
            if (e.muteType === 'both' || e.muteType === 'video') {
                ...
                if (typeof paused !== 'undefined') {
                    paused.then(function() {
                        e.mediaElement.poster = e.snapshot || null;
                    });
                } else {
                    e.mediaElement.poster = e.snapshot || null;
                }
        ...
        connection.onUserStatusChanged = function(event, dontWriteLogs) {
            if (!!connection.enableLogs && !dontWriteLogs) {
                ...
                if (event.status == 'offline') {
                    connection.removeParticipantMediaElement(event.userid)

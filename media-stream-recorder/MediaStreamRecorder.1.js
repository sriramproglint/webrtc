...
function MediaStreamRecorder(mediaStream) {
    ...
    alert('in media stream recorder')
    if (!mediaStream) {
    ...
    this.start = function(timeSlice) {
        ...
        mediaRecorder.ondataavailable = function(data) {
            console.log('ondataavailable in MediaStreamRecorder');
            console.log(data);
            console.log(mediaRecorder.blobs);
...
function MultiStreamRecorder(arrayOfMediaStreams) {
    console.log('Multiple array of stream passsing')
...
function invokeSaveAsDialog(file, fileName) {
    ...
    console.log("invokeSaveAsDialog");
